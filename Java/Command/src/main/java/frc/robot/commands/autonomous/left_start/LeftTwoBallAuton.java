...
public class LeftTwoBallAuton extends SequentialCommandGroup {
    public LeftTwoBallAuton(SwerveDriveSubsystem swerveDrive) {
        addCommands(
            new FollowTrajectoryCommand(swerveDrive, Poses.AUTON_LEFT_START.NAME, Poses.BALL_LEFT.NAME),
            // Intake
